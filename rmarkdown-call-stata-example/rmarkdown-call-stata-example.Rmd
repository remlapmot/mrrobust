---
title: Using `TwoSampleMR` and `mrrobust` code in the same Rmarkdown script
author: Tom Palmer
...
To see the `Rmd` code which generates this page see [here](./rmarkdown-call-stata-example.Rmd). It consists of R code chunks and Stata code chunks.
